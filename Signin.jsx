...
import bgimage from '../assets/images/sliderphoto2.jpg';

const Signin = () => {
    return (
        <div
          className="flex min-h-screen bg-cover bg-center"
          style={{ backgroundImage: `url(${bgimage})` }} // Arka plan resmi
        >
          ...
          <div className="w-1/2 flex flex-col justify-center items-start p-10 ml-20 bg-opacity-50">
            ...
            <a href="#" className="mt-2 text-black hover:underline">Forgot Password?</a>
          </div>
          ...
          <div className="w-1/2 flex flex-col bg-opacity-50 justify-center items-center p-10 text-black space-y-2">
